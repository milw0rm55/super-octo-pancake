...
var palabras = ["brown", "blue","yellow","red","purple","green","pink","orange","black","white","grey"];
...
function buscar(letra) {
	...
	for (var i=0; i<longitud; i++){
		if (letra==palabra[i]) {
			...
			document.getElementById(i).style.fontFamily="'ZCOOL KuaiLe', cursive";
			contador++;
			bandera=true;
			};
	}
